...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO diamond_prices (Gemstone, Weight, Currency, Price) VALUES (?, ?, ?, ?)";
    ...
    <form method="POST" action="">
      ...
      <div class="form-group">
        ...
        <select name="Gemstone" required>
          ...
          <option value="Fancy Color Diamond">Fancy Color Diamond</option>
       ...
       <div class="form-group">
        ...
        <select name="Weight" required>
          ...
          <option value="2 carat">2 carat</option>
        </select>
      </div>
      ...
      <button type="submit">💰 Save Diamond Rate</button>
    </form>
  </div>
</div>
