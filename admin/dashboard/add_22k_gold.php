...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($Weight && $QAR && $USD && $INR) {
        // Prepare SQL
        $sql = "INSERT INTO `22k_gold` (Weight, Currencies, Prices, created_at) VALUES (?, ?, ?, NOW())";
        ...
        header("Location: view_22k_gold.php?success=1");
        exit();
    } else {
...
<div class="form-wrapper">
  <div class="form-container">
    ...
    <form method="POST" action="">
      ...
      <button type="submit">💰 Save 22K Gold Rate</button>
    </form>
  </div>
</div>
