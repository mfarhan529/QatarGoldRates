...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($Weight && $QAR && $USD && $INR) {
        // Prepare SQL
        $sql = "INSERT INTO `14k_gold` (Weight, Currencies, Prices, created_at) VALUES (?, ?, ?, NOW())";
        ...
        header("Location: view_14k_gold.php?success=1");
        exit();
    } else {
...
<div class="form-wrapper">
  <div class="form-container">
    ...
    <form method="POST" action="">
      ...
      <button type="submit">💰 Save 14K Gold Rate</button>
    </form>
  </div>
</div>
