...
<div class="tables-container">
  <!-- ✅ Today’s Diamond Prices -->
  <div class="today-table">
    <h2>Today’s Diamond Prices</h2>
    <table class="table">
      <tr>
      ...
      <tr>
        ...
        <td><?= $row['Price'] ?></td>
     <td>
  <a href="delete.php?id=<?= $row['id'] ?>&type=diamond"
     class="delete-btn"
  ...
  <!-- ✅ History Diamond Prices -->
  <div class="history-table">
    <h2>History Diamond Prices</h2>
    <table>
      <tr>
        <th>Date</th>
        <th>Gemstone</th>
