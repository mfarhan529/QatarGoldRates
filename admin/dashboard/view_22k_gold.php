      ...
      if ($pivot_result->num_rows > 0) {
        while($row = $pivot_result->fetch_assoc()) { ?>
          <tr>
            ...
            <td>
              <a href="delete.php?weight=<?= urlencode($row['Weight']) ?>&type=22k_gold"
                 class="delete-btn"
      ...
      if ($history_pivot_result && $history_pivot_result->num_rows > 0) { 
        ...
        ?>
          <tr>
            ...
            <td>
              <a href="delete.php?date=<?= urlencode($row['PriceDate']) ?>&type=22k_gold_history"
                 class="delete-btn"
