...
$today_sql = "SELECT id, Weight, Currency, Price, created_at 
...
$history_sql = "SELECT id, Weight, Currency, Price, created_at 
                FROM platinum_prices
                WHERE created_at < NOW() - INTERVAL 1 DAY 
                ORDER BY created_at DESC";
  ...
  <div class="today-table">
    ...
    <table class="table">
      ...
      <tr>
        ...
        <td><?= $row['Price'] ?></td>
     <td>
  <a href="delete.php?id=<?= $row['id'] ?>&type=platinum"
     class="delete-btn"
