...
<div class="tables-container">
  <!-- ✅ Today’s Sapphire Prices -->
  <div class="today-table">
    <h2>Today’s Sapphire Prices</h2>
    <table class="table">
      <tr>
      ...
      <tr>
        ...
        <td><?= $row['Price'] ?></td>
     <td>
  <a href="delete.php?id=<?= $row['id'] ?>&type=sapphire"
     class="delete-btn"
  ...
  <!-- ✅ History Sapphire Prices -->
  <div class="history-table">
    <h2>History Sapphire Prices</h2>
    <table>
      <tr>
        <th>Date</th>
        <th>Gemstone</th>
